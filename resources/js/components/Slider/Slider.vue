    ...
    <section class="px-5 lg:px-0 relative lg:py-20">
        ...
        <div class="space-y-5 lg:space-y-0 lg:grid grid-cols-12 gap-10 container mx-auto">
            ...
            <div class="col-span-6">
                <div v-if="details">
                    <div class="space-y-5 lg:space-y-10 mb-10 text-center lg:text-left">
                        <h1 class="font-pfd text-4xl  lg:text-8xl font-black">
                    ...
                    <div class="mt-10 lg:flex items-center gap-10">
                        <Btn class="justify-center lg:justify-start" is="a" type="primary" :href="details.primary_action_url">
                            {{ details.primary_action_text[locale] }}
                        </Btn>
                        <Btn is="a" class="justify-center lg:justify-start hover:opacity-50 flex gap-3 items-center" :href="details.secondary_action_url">
            ...
            <div class="col-span-6">
                <div class="relative overflow-hidden border">
                    <TransitionGroup>
                        <div key="placeholder" v-if="!isLoaded" class="skeleton bg-neutral-200"></div>
