<template>
    <div>
        ...
        <div
            class="flex flex-col justify-between px-5 pt-5 pb-10 fixed z-50 w-full duration-100 h-screen top-0 bg-white"
